...
from app.services.auth import verify_token, create_access_token, verify_password, get_password_hash
...
router = APIRouter(prefix="/admin", tags=["Administracija"], dependencies=[Depends(get_current_admin)])
